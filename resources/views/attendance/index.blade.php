                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-sm-4 mb-3 mb-sm-2" style="text-align: center;">
                                    ...
                                    <div class="mt-4">
                                        <a href="javascript:void(0);" class="btn btn-primary waves-effect waves-light btn-sm" data-toggle="modal" data-target="#exampleModalCenter">Check In <i class="bx bx-time"></i></a>
                                    </div>
                                </div>
