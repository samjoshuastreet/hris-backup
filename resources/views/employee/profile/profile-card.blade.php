        ...
        <div class="info">
            <table>
                <tbody>
                    <tr>
                        <th>Gender</th>
                        <td class="text-truncate">{{ $target->gender }}</td>
                    </tr>
                    <tr>
                        <th>Email</th>
                        <td class="text-truncate">{{ $target->email_address}}</td>
                    </tr>
                    <tr>
                        <th>Address</th>
                        <td>
                            <p class="text-truncate">{{ $target->permanent_address}}</p>
                        </td>
                    </tr>
                    <tr>
                        <th>Position</th>
                        <td class="text-truncate">Front End developer</td>
                    </tr>
                    <tr>
                        <th>Department</th>
                        <td class="text-truncate">IT department</td>
                    </tr>
                </tbody>
            </table>
        </div>
