<ul class="metismenu list-unstyled" id="side-menu">
    ...
    <li>
        <a href="/department">
            ...
            <span key="t-blog">Department</span>
        </a>
    </li>
    <li>
        ...
        <ul class="sub-menu" aria-expanded="true">
            ...
            <li>
                ...
                <ul class="sub-menu" aria-expanded="true">
                    <li><a href="javascript: void(0);" key="t-level-2-1">IT Department</a></li>
                    <li><a href="javascript: void(0);" key="t-level-2-2">HR Department</a></li>
                </ul>
            </li>
        </ul>
    </li>
