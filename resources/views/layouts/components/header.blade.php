    ...
    <div class="d-flex">
        ...
        <div class="navbar-brand-box">
            {{-- <a href="index.html" class="logo logo-dark">
                <span class="logo-sm">
                    <img src="{{ asset('assets/images/pixzel_image.png') }}" alt="" height="22">
            </span>
            <span class="logo-lg">
                <img src="{{ asset('assets/images/pixzel_image.png') }}" alt="" height="17">
            </span>
            </a> --}}
    ...
    <div class="d-flex">
        ...
        <div class="dropdown d-inline-block">
            ...
            <div class="dropdown-menu dropdown-menu-end">
                <!-- item-->
                @if(isset($employee))
                <a class="dropdown-item" href="{{ route('view', ['id' => $employee->id]) }}"><i class="bx bx-user font-size-16 align-middle me-1"></i> <span key="t-profile">Profile</span></a>
                @endif
                <a class="dropdown-item d-block" href="#"><span class="badge bg-success float-end">11</span><i class="bx bx-wrench font-size-16 align-middle me-1"></i> <span key="t-settings">Settings</span></a>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item text-danger" href="{{ route('logout_user') }}"><i class="bx bx-power-off font-size-16 align-middle me-1 text-danger"></i> <span key="t-logout">Logout</span></a>
            </div>
        </div>
